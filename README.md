<div align="center">
    <img alt="logo" src="https://img.121566.xyz/file/1765298577192_256x256.png" />
</div>
...
- **JetBrains Mono 字体恢复**：恢复代码块字体样式（v2.4.6 误删除的 `<style>` 标签）
- **微信公众号兼容性提升**：代码块在微信公众号中正确显示缩进和字体
...
![文颜-rev示例图](https://img.121566.xyz/file/1767416886009_文颜-rev示例图.png)
...
![](https://img.121566.xyz/file/1765256160897_wx.png) ![](https://img.121566.xyz/file/1765256161114_zfb.png)
